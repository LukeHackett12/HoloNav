...
extern "C" IL2CPP_METHOD_ATTR float Enumerable_Average_m677900329 (RuntimeObject * __this /* static, unused */, RuntimeObject* ___source0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_1, NULL, Enumerable_Average_m677900329_RuntimeMethod_var);
	}
	...
	{ // begin try (depth: 1)
		{
			...
			NullCheck(L_4);
			bool L_5 = InterfaceFuncInvoker0< bool >::Invoke(0 /* System.Boolean System.Collections.IEnumerator::MoveNext() */, IEnumerator_t1853284238_il2cpp_TypeInfo_var, L_4);
			if (L_5)
			{
				goto IL_0023;
			}
...
IL_001d:
		{
			Exception_t * L_6 = Error_NoElements_m207875825(NULL /*static, unused*/, /*hidden argument*/NULL);
			IL2CPP_RAISE_MANAGED_EXCEPTION(L_6, NULL, Enumerable_Average_m677900329_RuntimeMethod_var);
		}
...
IL_0023:
		{
			...
			NullCheck(L_7);
			float L_8 = InterfaceFuncInvoker0< float >::Invoke(0 /* !0 System.Collections.Generic.IEnumerator`1<System.Single>::get_Current() */, IEnumerator_1_t1829837242_il2cpp_TypeInfo_var, L_7);
			V_1 = (((double)((double)L_8)));
...
IL_0030:
		{
			...
			NullCheck(L_10);
			float L_11 = InterfaceFuncInvoker0< float >::Invoke(0 /* !0 System.Collections.Generic.IEnumerator`1<System.Single>::get_Current() */, IEnumerator_1_t1829837242_il2cpp_TypeInfo_var, L_10);
			V_1 = ((double)il2cpp_codegen_add((double)L_9, (double)(((double)((double)L_11)))));
			int64_t L_12 = V_2;
			V_2 = ((int64_t)il2cpp_codegen_add((int64_t)L_12, (int64_t)(((int64_t)((int64_t)1)))));
		}
...
IL_0047:
		{
			double L_15 = V_1;
			int64_t L_16 = V_2;
			V_3 = (((float)((float)((double)((double)L_15/(double)(((double)((double)L_16))))))));
